...
if [ "$?" != "0" ] ; then
  curl -sL https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/4.17.0-rc.2/oc-mirror.rhel9.tar.gz | tar xvz -C /usr/bin
  chown root:root /usr/bin/oc-mirror
